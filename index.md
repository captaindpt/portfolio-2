...
<p class="home-thesis">i build systems that turn undocumented, chaotic data into structured knowledge - and tools that close the gap between AI models and physical hardware.</p>
